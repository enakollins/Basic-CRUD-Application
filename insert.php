...
if(isset($_POST['submit']))
  ...
  // Query for data insertion
     $query=mysqli_query($con, "insert into tblusers(Coursecode, CourseTitle) value('$ccode', '$ctitle')");
    if ($query) {
...
<div class="signup-form">
	...
	<!-- </div>
        <div class="form-group">
            <input type="text" class="form-control" name="level" placeholder="Enter your level" required="true" maxlength="10" pattern="[0-9]+">
        </div>
 -->
		<div class="form-group">
	...
	<a href="dashboard.php" class="btn btn-danger ml-3">Back</a>
</div>
</body>
</html>